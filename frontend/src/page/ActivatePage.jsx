...
const Activate = () => {
  ...
  const clickSubmit = (e) => {
    ...
    axios({
      method: "POST",
      url: `http://localhost:5000/api/account-activation`, // Assuming this is your activation endpoint
  ...
  const activationLink = () => (
    <div className=" text-center">
      ...
      <button className="btn btn-lg btn-outline-success" onClick={clickSubmit}>
        {value.buttonText}
      </button>
    </div>
  );
